# Shopkeeper Sales Ledger Estimator
        
create a estimation book which need to used by shopkeeprs for there daily sales with ledger, also need to tag payment type in estimation book,
